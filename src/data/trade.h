...
static const u8 sText_CommunicationStandby[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Connexion…\nVeuillez patienter.");
static const u8 sText_TheTradeHasBeenCanceled[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}L'échange a été\nannulé.");
static const u8 sText_OnlyPkmnForBattle[] = _("[COLOR DARK_GRAY][HIGHLIGHT WHITE][SHADOW LIGHT_GRAY]C'est votre seul\nPOKéMON pour combattre.");
static const u8 sText_WaitingForYourFriend[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Votre ami(e) n'a pas\nencore fini…");
